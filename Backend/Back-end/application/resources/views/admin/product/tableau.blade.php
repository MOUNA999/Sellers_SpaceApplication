                        ...
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <button class="btn btn-info float-right" data-toggle="modal" onclick="window.location.href='{{ route('addProductForm') }}'" >Ajouter collection</button>
                                                        ...
                                                        @foreach($products as $product)
                                                            <tr>
                                                                ...
                                                                <td style="text-align:center">
                                                                    <i class="fa fa-refresh" aria-hidden="true" style="font-size:22px;cursor: pointer;" onclick="window.location.href='{{ route('updateProduct', ['id' => $product->id]) }}'"></i>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
