        ...
        <div class="">
          <div class="page-title">
            <div class="title_left">
              <h3>Mise à Jour du Profil Vendeuse</h3>
            </div>
          </div>
                ...
                <div class="x_content">
                  <div class="row">
                    <div class="col-md-12 col-sm-12">
                      <div class="x_panel">
                        <div class="x_title">
                          <h2>Détails du Compte Vendeuse</h2>
                        ...
                        <div class="x_content">
                          <br />
                          <form id="demo-form2" method="POST" action="{{ route('admin.updateVendeuse', $vendeuse) }}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                <input type="text" value="{{ $vendeuse->id }}" name="id" style="style="display: none"">


                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">First Name</label>
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" value="{{ $vendeuse->nom }}" id="first-name" name="nom" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input type="text" value="{{ $vendeuse->prenom }}"  id="last-name" name="prenom" class="form-control" required>
                                </div>
                            </div>
                        ...
                        <form method="POST" action="/vendeuse/changePassword" >
                            @csrf
                            @method('PUT')
                            <input type="hidden"  name="id" style="style="display: none"">
