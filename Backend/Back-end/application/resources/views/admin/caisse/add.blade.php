                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="x_panel">
                                    ...
                                    <br>
                                    <div class="x_content">
                                        <form class="" action="{{ route('addCaisse') }}" method="post" novalidate>
                                            @csrf
                                            ...
                                            <div class="field item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" name="code_caisse" type="text" required="required" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="field item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3  label-align"><strong><i>Point de vente  </i></strong><span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6">
                                                    <select class="form-control" name="point_vente_ID">
                                                        <option value="">Choose option</option>
                                                        <option value="1" >Beb bhar</option>
                                                        <option value="2" >Nassria</option>
                                            ...
                                            <div class="field item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" name="code" type="number" required="required" />
                                                </div>
                                            </div>
