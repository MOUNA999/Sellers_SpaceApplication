                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="x_panel">
                                    ...
                                    <br>
                                    <div class="x_content">
                                        <form class="" method="POST" action="{{ route('admin.updateCaisse', $caisse) }}" novalidate>
                                            @csrf
                                            @method('PUT')
                                            <div class="field item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3  label-align"><strong><i>Code Caisse </i></strong> <span class="required">*</span></label>
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" name="code_a_bar" value="{{ $caisse->code_caisse}}" type="text" required="required" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="field item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" class='date' type="date" value="{{$caisse->date}}"  name="date" required='required'></div>
                                            </div>
                                            <div class="field item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <select class="form-control" name="point_vente_ID">
                                                        ...
                                                        @foreach($pointsVente as $pointVente)
                                                            <option value="{{ $pointVente->id }}" {{ $caisse->point_vente_ID == $pointVente->id ? 'selected' : '' }}>{{ $pointVente->libelle }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="field item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <input class="form-control" name="code_a_bar" value="{{ $caisse->code}}" type="text" required="required" />
                                                </div>
                                            </div>
