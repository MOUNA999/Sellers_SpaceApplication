                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Liste des Point de vente</h2>
                                    <button class="btn btn-info float-right" data-toggle="modal" data-target="#exampleModal">Importer CSV</button>
                                    <button class="btn btn-info float-right" data-toggle="modal" onclick="window.location.href='{{ route('addPointVenteForm') }}'" >Ajouter collection</button>
                                                ...
                                                <table class="table table-striped table-bordered"
                                                    ...
                                                    <tbody>
                                                        @foreach($pointVentes as $pointVente)
                                                            <tr>
                                                                <td>{{ $pointVente->code }}</td>
                                                                <td>{{ $pointVente->libelle }}</td>


                                                                <td style="text-align:center">
                                                                    <i class="fa fa-refresh" aria-hidden="true" style="font-size:22px;cursor: pointer;" onclick="window.location.href='{{ route('updatePointVente', ['id' => $pointVente->id]) }}'"></i>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
